...
namespace EF_With_SignalR_MVC.Controllers
{
    public class ProductsController : Controller
    {
        private readonly ApplicationDbContext _context;
        private readonly IHubContext<SignalrServer> _signalrHub;
        public ProductsController(ApplicationDbContext context, IHubContext<SignalrServer> _signalrHub)
        {
            _context = context;
            this._signalrHub = _signalrHub;
        }
